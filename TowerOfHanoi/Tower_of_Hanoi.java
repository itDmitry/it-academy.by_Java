...
6. Игровое поле в консоли отображает немного по другому. Цифра - это кольцо определённого размера,
* - это пустое место на стержне. Пример: Если пользователь выберет что он будет играть с 4-мя кольцами,
...
(кольцо 2 на стержень 3 с кольцом 1). Выводим сообщение:
К сожалению данный ход не возможен правилами игры, выберите другой ход.
...
public class Tower_of_Hanoi {
    public static void main(String[] args) {
        ...
        System.out.println("Введи число фигур");
        int chisloFigur = scanner.nextInt();

        int[][][][] pole = new int[3][chisloFigur][][];

        for (int i = 0; i < chisloFigur; i++) {
//            pole[1][i] = i+1;
        }
